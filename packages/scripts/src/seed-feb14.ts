/**
 * Seed Supabase with all 288 BTC 5-min markets from Feb 14, 2026 (UTC day).
 *
 * Identical approach to seed-feb13.ts — consecutive with the last Feb 13 market.
 ...
 *
 * Run: pnpm --filter scripts seed:feb14
 */
...
// Feb 14, 2026 00:00:00 UTC = Feb 13 base + 86400
const BASE_TS = 1771027200;
...
async function main() {
  console.log(`Seeding ${MARKETS_PER_DAY} markets for Feb 14, 2026 (UTC day)...\n`);
